    ...
    <div class="col-md-12">
        <div class="col-md-6">
                <?php
                    ...
                    $fecha = date("dm");
                ?>
        <h4 class="modal-title">Cotizacion Nro: <?php echo $this->lang->lin.strtoupper("$user_info->first_name"); ?>-<?php echo "$cadena"."-"."$fecha"; ?>-C</h4>
        </div>
    </div>
</div>
<hr/>
<div class="row">
    ...
    <?php if (isset($datos)): ?>
            <form id="form_customer_data" role="form">
                ...
                <div class="col-md-4" class="form-group">
                    <label>Email</label>
                    <input id="customer_address" name="customer_address" class="form-control" <?php echo $datos['email']; ?>" disabled="true">
                </div>
                <div class="col-md-2" class="form-group">
        ...
        <?php echo form_open('travel/saveComision',array('id'=>'form_travel_comision_save','class' => 'form-inline')); ?>
            <fieldset>
                ...
                <div class="form-group">
                  ...
                  <button style="float: right" type="button" class="btn btn-primary btn_save_travel">Generar Cotizacion</button>
            </fieldset>
